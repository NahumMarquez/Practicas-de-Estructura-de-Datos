    ...
    do {
        ...
        when (opcion) {
            1 -> {
                ...
                val nombre = readLine() ?: ""
                println("Ingresar la prioridad de la tarea: ")
            ...
            2 -> {
                if (listaTareas.size() > 0) {
                    ...
                    val tareaAEliminar = listaTareas.getAll().find { it.nombre == eliminarTarea }
            ...
            4 -> {
                println("Lista de tareas ordenada por prioridad")
